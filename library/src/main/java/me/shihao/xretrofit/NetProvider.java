package me.shihao.xretrofit;

import me.shihao.xretrofit.https.HttpsManager;
import me.shihao.xretrofit.https.SSLParams;
...
public class NetProvider {
    ...
    /**
     * 设置cookie保存,默认不保存，内置实现了：内存保存{@link me.shihao.xretrofit.cookie.store.MemoryCookieStore},
     * 持久化SharedPreferences中保存{@link me.shihao.xretrofit.cookie.store.PersistentCookieStore}
     *
     * @return null 默认不保存
     */
    ...
    /**
     * 日志输出等级 {@link me.shihao.xretrofit.LoggingInterceptor.Level}
     *
     * @return
     * @see me.shihao.xretrofit.LoggingInterceptor.Level
     */
